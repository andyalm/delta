...
namespace Delta
{
        ...
        /// </summary>
        public class DeltaVersionedApiExplorer : IApiExplorer
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DeltaVersionedApiExplorer"/> class.
            /// </summary>
            /// <param name="configuration">The configuration.</param>
            public DeltaVersionedApiExplorer(HttpConfiguration configuration)
            {
            ...
            /// <summary>
            /// Determines whether the controller should be considered for <see cref="DeltaVersionedApiExplorer.ApiDescriptions"/> generation. Called when initializing the <see cref="DeltaVersionedApiExplorer.ApiDescriptions"/>.
            /// </summary>
            /// <param name="controllerVariableValue">The controller variable value from the route.</param>
            /// <param name="controllerDescriptor">The controller descriptor.</param>
            /// <param name="route">The route.</param>
            /// <returns><c>true</c> if the controller should be considered for <see cref="DeltaVersionedApiExplorer.ApiDescriptions"/> generation, <c>false</c> otherwise.</returns>
            ...
            /// <summary>
            /// Determines whether the action should be considered for <see cref="DeltaVersionedApiExplorer.ApiDescriptions"/> generation. Called when initializing the <see cref="DeltaVersionedApiExplorer.ApiDescriptions"/>.
            /// </summary>
            /// <param name="actionVariableValue">The action variable value from the route.</param>
            /// <param name="actionDescriptor">The action descriptor.</param>
            /// <param name="route">The route.</param>
            /// <returns><c>true</c> if the action should be considered for <see cref="DeltaVersionedApiExplorer.ApiDescriptions"/> generation, <c>false</c> otherwise.</returns>
            ...
            /// <summary>
            /// Gets a collection of HttpMethods supported by the action. Called when initializing the <see cref="DeltaVersionedApiExplorer.ApiDescriptions"/>.
            /// </summary>
            /// <param name="route">The route.</param>
            /// <param name="actionDescriptor">The action descriptor.</param>
